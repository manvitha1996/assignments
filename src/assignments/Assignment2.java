...
public class Assignment2 {
	...
	public static void main(String[] args) {
		...
		data [4][1][5] = "Pass(90)";
		 ...
		 System.out.println( data [3][1][2]);
		  System.out.println( data [3][1][5] );
