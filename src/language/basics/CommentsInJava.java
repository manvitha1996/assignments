...
public class CommentsInJava {
			...
			// 2. Multiple line comments ===> /*....*/---> Cntrl+Shift+/ (comment) , Cntrl+Shift+\(uncomment)
			// 3. Documentation comments ===> /**......*/--->Alt+Shift+J
		

		/* The line refers to the main method.
		 ...
		 * so, whenever we want to run the program, first you need to create a main method.
